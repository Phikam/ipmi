//Evelyn Beatriz Gualtieri
//Comision 1
//tp 2 - pelicula -

//corregido para recuperatorio
   ...
   //////Pantalla de Patapez/////////////////////////
    ...
    if (yAnim > 380) {
      yAnim -= 5;
       ...
       if (mouseX > 220 && mouseX < 420 && mouseY > yAnim - 30 && mouseY < yAnim + 30) {
      fill(255, 255, 0, alphaP1); 
      textSize(36); 
    } else {
      fill(255, alphaP1); 
...
void mousePressed(){ //condicional para activar el boton
 ...
 if(pantalla == 6 && mouseX > 220 && mouseX < 420 && mouseY >  yAnim - 30 && mouseY < yAnim + 30){
   pantalla = 0;
   alphaMenu = 255;
